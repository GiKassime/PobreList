        ...
        <div class="col-12">
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center align-items-center gap-2 flex-wrap">
                    <img src="../../src/img/comprado.png" alt="Estrela esquerda" class="d-none d-md-block" style="height:clamp(80px, 12vw, 150px);width:auto;transform: scaleX(-1);">
                    ...
                    <img src="../../src/img/comprado.png" alt="Estrela direita" class="d-none d-md-block" style="height:clamp(80px, 12vw, 150px);width:auto;">
                </div>
            </div>
