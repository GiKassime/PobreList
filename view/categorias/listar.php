    ...
    <div class="row g-3 align-items-center justify-content-center mb-4">
        <div class="row justify-content-center mb-5">
            <div class="col-12 w-100 d-flex justify-content-center align-items-center gap-2 flex-wrap">
                <img src="../../src/img/categoria.png" alt="Estrela esquerda" style="height:150px;width:auto;transform: scaleX(-1);">
                ...
                <img src="../../src/img/categoria.png" alt="Estrela direita" style="height:150px;width:auto;">
            </div>
        </div>
